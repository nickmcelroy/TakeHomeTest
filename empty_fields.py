...
assert "Please fill in all of the required fields" in error_message.text, "Error message for empty fields not displayed"

# If the assertion passes print a success message
print("Empty fields test passed successfully!")
