...
# Find the apple button by id
apple_button = driver.find_element(By.ID, "btn-apple-login")
...
assert "Sign in with Apple" in driver.title, "Not directed to correct page"

# If the assertion passes print a success message
print("Apple ID button test passed!")
