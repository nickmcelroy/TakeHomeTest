...
# Send password and empty email credentials
empty_email = ""
password = "password" # Can be valid or invalid

email_field.send_keys(empty_email)
...
assert "Please fill in all of the required fields" in error_message.text, "Error message for empty email not displayed"

# If the assertion passes print a success message
print("Empty email test passed successfully!")
