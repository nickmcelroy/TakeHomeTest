...
# Find the google button by id
google_button = driver.find_element(By.ID, "btn-google-login")
...
# Test to make sure that the title of the driver after the button is pressed contains phrase
assert "Sign in - Google Accounts" in driver.title, "Not directed to correct page"

# If the assertion passes print a success message
print("Google button test passed!")
